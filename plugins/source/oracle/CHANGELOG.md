...
## [4.2.4](https://github.com/cloudquery/cloudquery/compare/plugins-source-oracle-v4.2.3...plugins-source-oracle-v4.2.4) (2023-11-22)
...
## [4.2.3](https://github.com/cloudquery/cloudquery/compare/plugins-source-oracle-v4.2.2...plugins-source-oracle-v4.2.3) (2023-11-16)
...
* Set global retry policy to `common.DefaultRetryPolicy` ([#15135](https://github.com/cloudquery/cloudquery/issues/15135)) ([b7a98de](https://github.com/cloudquery/cloudquery/commit/b7a98de00f93182517e31bd1ff7dee099b33f440))
...
## [4.2.0](https://github.com/cloudquery/cloudquery/compare/plugins-source-oracle-v4.1.0...plugins-source-oracle-v4.2.0) (2023-10-04)


### Features

* Use autogenerated JSON schema ([#14275](https://github.com/cloudquery/cloudquery/issues/14275)) ([eb183a9](https://github.com/cloudquery/cloudquery/commit/eb183a902ac90189ea70c30d83d101dc36a64ac5))
...
* **deps:** Update module github.com/cloudquery/codegen to v0.3.4 ([#14285](https://github.com/cloudquery/cloudquery/issues/14285)) ([9eedc4c](https://github.com/cloudquery/cloudquery/commit/9eedc4cc6b44eb37d26c250fdefa51d2469b6558))

## [4.1.0](https://github.com/cloudquery/cloudquery/compare/plugins-source-oracle-v4.0.8...plugins-source-oracle-v4.1.0) (2023-09-28)


### Features

* Use JSON schema for spec validation ([#13961](https://github.com/cloudquery/cloudquery/issues/13961)) ([ff934fe](https://github.com/cloudquery/cloudquery/commit/ff934fed1b99b766405cc06d9a3a315535040f36))
...
## [4.0.8](https://github.com/cloudquery/cloudquery/compare/plugins-source-oracle-v4.0.7...plugins-source-oracle-v4.0.8) (2023-09-12)
...
## [4.0.7](https://github.com/cloudquery/cloudquery/compare/plugins-source-oracle-v4.0.6...plugins-source-oracle-v4.0.7) (2023-09-05)
...
## [4.0.6](https://github.com/cloudquery/cloudquery/compare/plugins-source-oracle-v4.0.5...plugins-source-oracle-v4.0.6) (2023-08-29)
...
## [4.0.5](https://github.com/cloudquery/cloudquery/compare/plugins-source-oracle-v4.0.4...plugins-source-oracle-v4.0.5) (2023-08-15)
...
## [4.0.4](https://github.com/cloudquery/cloudquery/compare/plugins-source-oracle-v4.0.3...plugins-source-oracle-v4.0.4) (2023-08-10)
...
## [4.0.3](https://github.com/cloudquery/cloudquery/compare/plugins-source-oracle-v4.0.2...plugins-source-oracle-v4.0.3) (2023-08-08)
...
## [4.0.2](https://github.com/cloudquery/cloudquery/compare/plugins-source-oracle-v4.0.1...plugins-source-oracle-v4.0.2) (2023-07-25)
...
## [4.0.1](https://github.com/cloudquery/cloudquery/compare/plugins-source-oracle-v4.0.0...plugins-source-oracle-v4.0.1) (2023-07-18)
...
## [4.0.0](https://github.com/cloudquery/cloudquery/compare/plugins-source-oracle-v3.1.0...plugins-source-oracle-v4.0.0) (2023-07-14)


### ⚠ BREAKING CHANGES

* Upgrades the oracle source plugin to use plugin-sdk v4. This version does not contain any user-facing breaking changes, but because it is now using CloudQuery gRPC protocol v3, it does require use of a destination plugin that also supports protocol v3. All recent destination plugin versions support this.

### Features

* Upgrades the oracle source plugin to use plugin-sdk v4. This version does not contain any user-facing breaking changes, but because it is now using CloudQuery gRPC protocol v3, it does require use of a destination plugin that also supports protocol v3. All recent destination plugin versions support this. ([aef2ee7](https://github.com/cloudquery/cloudquery/commit/aef2ee7257c90e510af36206cf08927a2f0e234f))
